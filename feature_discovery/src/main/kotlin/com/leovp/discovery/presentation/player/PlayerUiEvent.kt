...
class SongEventDelegate @Inject constructor() : EventDelegate<PlayerUiEvent.SongEvent> {
...
class PlayerDelegate @Inject constructor() : EventDelegate<PlayerUiEvent.PlayerEvent> {
...
class PlayerExtraDelegate @Inject constructor() : EventDelegate<PlayerUiEvent.ExtraEvent> {
